...
function SectionEditor({
  ...
  return (
    <div className="mx-auto max-w-3xl px-8 py-8">
      ...
      {confirms > 0 && (
        <div className="mt-4 flex items-center gap-2 rounded-lg border border-amber-200 bg-amber-50 px-4 py-2.5 text-[13px] text-amber-800">
            ...
            <div className="min-w-0 flex-1">
              ...
              {block.needsConfirm && (
                <div className="mt-2 flex items-center gap-2">
                  <Badge variant="outline" className="h-5 gap-1 border-amber-300 bg-amber-100/60 text-[10px] text-amber-700">
                  ...
                  <Button size="sm" variant="outline" className="h-6 bg-white px-2 text-[11px]" onClick={onStartEdit}>
