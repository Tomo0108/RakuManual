...
const expenseFlow: FlowState = patchFlowSectionNumbers(
  ...
  [
    ...
    { id: "n2", type: "step", data: { label: "経費精算システムへ申請内容を入力", lane: "申請者", kind: "process", system: "楽々精算クラウド", source: "q8: 手順1", sectionNumber: "1.1" } },
    { id: "n3", type: "step", data: { label: "領収書画像を添付して申請", lane: "申請者", kind: "process", system: "楽々精算クラウド", source: "q8: 手順2", sectionNumber: "1.2" } },
    { id: "n4", type: "step", data: { label: "金額が5万円以上?", lane: "経理担当", kind: "decision", source: "q9: 分岐条件", sectionNumber: "2.1" } },
    { id: "n5", type: "step", data: { label: "部長が承認", lane: "上長", kind: "process", system: "ワークフロー", source: "q9: 5万円以上は部長承認", sectionNumber: "2.1" } },
    { id: "n6", type: "step", data: { label: "課長が承認", lane: "上長", kind: "process", system: "ワークフロー", source: "q9: 5万円未満は課長承認", manual: true, sectionNumber: "2.1" } },
    { id: "n7", type: "step", data: { label: "経理が内容を確認・仕訳", lane: "経理担当", kind: "process", system: "会計システム", source: "q8: 手順4", sectionNumber: "2.2" } },
  ...
  // マニュアル/深掘りと揃える: 承認分岐(n4–n6)は 2.1、経理確認は 2.2
  { n2: "1.1", n3: "1.2", n4: "2.1", n5: "2.1", n6: "2.1", n7: "2.2" },
)
...
export const INITIAL_PROJECTS: Project[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          { id: "b-o1", type: "paragraph", text: "以前は紙の回付で承認印をもらっていました（フローから削除済み・廃止候補）。" },
        ],
      },
    ],
    sectionRevisions: [
      {
        ...
        status: "review",
        blocks: [
          { id: "b1-old", type: "paragraph", text: "（旧版）経費精算の入力手順です。" },
        ],
      },
      {
        id: "rev-s1-2",
    ...
    history: [
      { id: "h0", date: "2026-07-10 09:00", user: "田中 花子", action: "フロー変更後のマニュアル見直し候補を確認中" },
